...
class OrderServiceImplTest {
    ...
    void test_placeOrder() {
        ...
        assertThat(orderCaptured.getCustomerName()).isEqualTo("김철수");
        assertThat(orderCaptured.getCustomerPhone()).isEqualTo("010-0000-0000");
        assertThat(orderCaptured.getCustomerAddress()).isEqualTo("서울시");
