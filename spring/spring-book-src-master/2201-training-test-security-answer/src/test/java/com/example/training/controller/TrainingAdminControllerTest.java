...
class TrainingAdminControllerTest {
    ...
    void test_displayList() throws Exception {
        ...
        mockMvc.perform(
                ...
                .andExpect(content().string(containsString("<span>Java 교육</span>")))
                .andExpect(content().string(containsString("<span>비즈니스 예절 교육"
                        + "</span>")))
        ;
    }
    ...
    void test_displayUpdateForm() throws Exception {
        ...
        mockMvc.perform(
                ...
                .andExpect(content().string(containsString("Java 교육")))
        ;
    }
    ...
    @Test
    void test_validateUpdateInput_입력오류() throws Exception {
        mockMvc.perform(
                        post("/admin/training/validate-update-input")
                )
    ...
    @Test
    void test_validateUpdateInput_입력오류2() throws Exception {
        mockMvc.perform(
                        post("/admin/training/validate-update-input")
                                .param("title", "Java 교육")
                                .param("startDateTime", "2021/12/01 09:30")
    ...
    void test_displayUpdateCompletion() throws Exception {
        mockMvc.perform(
                ...
                .andExpect(content().string(containsString("<h1>강의갱신완료</h1>")))
        ;
    }
